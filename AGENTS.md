...
- **익명 접근 검증** (§2.6) — 리포가 퍼블릭이더라도 GitHub Packages(npm) 는 별도 인증을 요구할 수 있음. `npm view @minjun0219/tsconfig --registry=https://npm.pkg.github.com` 응답 확인. 401/403 이면 §2.6 옵션 A/B 재검토
- **스크래치 리포 소비자 시나리오**:
   ```bash
